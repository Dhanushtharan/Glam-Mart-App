...
public class CarRentalSystem {
    ...
    public void registerCustomer(String name, String address, String email, String password, int age, String gender, String phone, String licenseNo) {
        ...
        try (Connection conn = getConnection();
            ...
            pstmt.setString(4, password); // Insert password
            pstmt.setInt(5, age);
    ...
    public Customer login(String email, String password) {
        ...
        try (Connection conn = getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                if (rs.next()) {
                    int custId = rs.getInt("cust_id"); // Retrieve the customer ID
                    ...
                    // Create the logged-in customer object
        ...
        return null; // Return null if login failed (invalid email or password)
    }
    ...
    public void rentCar(int carId, Date returnDate) {
        ...
        try (Connection conn = getConnection();
            ...
            // Book the car and update availability
    ...
    public static void main(String[] args) {
        ...
        // For demonstration purposes, let's add some sample data to the system.
        // You can replace this with database operations in a real-world application
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    Customer loggedInCustomer = carRentalSystem.login(email1, password1);
                    if (loggedInCustomer != null) {
                ...
                case 3:
                    List<Car> availableCars = carRentalSystem.viewAvailableCars();
                    System.out.println("\nAvailable Cars:");
                ...
                case 4:
                    ...
                    carRentalSystem.rentCar(carId, returnDate);
                    System.out.println("===========================");
                    break;
                ...
                case 5:
                    ...
                    carRentalSystem.returnCar(bookId);
                    System.out.println("===========================");
                    break;
